// items array
  const menuItems = [
    { name: 'Big Mac', price: 50, category: 'burger', image: './imgs/bigmac.jpg' },
    { name: 'Chicken McNuggets (9 stk.)', price: 28, category: 'sides', image: './imgs/nuggets.jpg' },
    { name: 'Pommes Frites', price: 25, category: 'sides', image: './imgs/fries.jpg' },
    { name: 'Cheese Burger', price: 12, category: 'burger', image: './imgs/cheeseburger.jpg' },
    { name: 'McChicken', price: 35, category: 'burger', image: './imgs/mcChicken.jpg' },
    { name: 'McBacon', price: 32, category: 'burger', image: './imgs/McBacon.jpg' },
    { name: 'Coca-Cola', price: 20, category: 'drinks', image: './imgs/cola.jpg' },
    { name: 'Sundae', price: 10, category: 'dessert', image: './imgs/sundae.jpg' },
    { name: 'McFlurry', price: 25, category: 'dessert', image: './imgs/mcFlurry.jpg' }, 
    { name: 'Fanta', price: 20, category: 'drinks', image: './imgs/fanta.jpg' },
    { name: 'Frappe KitKat', price: 28, category: 'drinks', image: './imgs/frappe.jpg' },
    { name: 'Mixed Team Box', price: 53, category: 'sides', image: './imgs/mixedTeamBox.jpg' },
    { name: 'Homestyle Kylling Bacon', price: 48, category: 'burger', image: './imgs/homestyleBacon.jpg' },
    { name: 'Chocolade Muffin', price: 18, category: 'dessert', image: './imgs/chocMuffin.jpg' },
    { name: 'Sukker Donut', price: 12, category: 'dessert', image: './imgs/sukkerDonut.jpg' },
    { name: 'Chocolade Donut', price: 12, category: 'dessert', image: './imgs/chocDonut.jpg' },
  ];
